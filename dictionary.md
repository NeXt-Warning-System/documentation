...
| MessageStatus      | Denotes appropriate handling of the Message - used in CAP e.g. Actual, Test |
...
| OrgTeamTel         | Public facing telephone number associated with an OrgTeam. Links to OrgTeam |
...
| TargetAreaCategory | Denotes the category of the TargetArea. Controls the available Message. Linked to EventType |
